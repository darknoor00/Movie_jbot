...
# ============================
SESSION = environ.get('SESSION', 'PIRO FILES')   # Session name for the bot
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002701581374'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002701581374'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002701581374'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002701581374').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002401915878')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002330472301')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+JOSoYYupAT9lMGE1')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002635232025")# Channels for force sub (make sure bot is admin)
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'PIRO_FILES') # Collection name (default: dreamcinezone_files)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/TheGlobalMovies') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/darknoor04') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/MovifyHD') # Update channel link for the bot
